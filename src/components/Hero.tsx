...
const Hero = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      {/* Background glow effect - Subtler for Pro look */}
      ...
      <div className="container relative z-10 px-4 py-20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold mb-6 leading-tight animate-fade-in-up tracking-tight" style={{ animationDelay: '0.1s' }}>
            <span className="text-white drop-shadow-2xl">Relamping LED Industriel</span>
            <br />
            <span className="text-blue-400 italic font-light drop-shadow-lg">& Économies d'Énergie Directes</span>
          </h1>

          {/* Subheadline */}
          <p className="text-lg md:text-xl text-white/90 max-w-2xl mx-auto mb-4 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
          ...
          <p className="text-white/80 mb-10 animate-fade-in-up" style={{ animationDelay: '0.3s' }}>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
            <Button
              ...
              variant="default"
              size="xl"
              className="w-full sm:w-auto shadow-[0_0_30px_rgba(37,99,235,0.6)] hover:shadow-[0_0_40px_rgba(37,99,235,0.8)] transition-all bg-blue-600 hover:bg-blue-500 text-white font-bold tracking-wide text-lg py-8 px-10 border-none"
        ...
        <div className="mt-12 animate-fade-in-up w-full max-w-screen-xl mx-auto" style={{ animationDelay: '0.5s' }}>
          <p className="text-sm font-medium text-white/90 mb-6 text-center uppercase tracking-wider">Nos certifications & partenaires</p>
          <div className="flex flex-wrap md:flex-nowrap items-center justify-center gap-8 md:gap-20 w-full px-4">
            <img
              ...
              className="h-28 md:h-44 w-auto object-contain hover:scale-105 transition-transform duration-300 drop-shadow-2xl"
              loading="eager"
              decoding="async"
              fetchPriority="high"
            ...
            <img
              ...
              className="h-24 md:h-36 w-auto object-contain hover:scale-105 transition-transform duration-300 drop-shadow-2xl"
              loading="eager"
              decoding="async"
            ...
            <img
              ...
              className="h-32 md:h-64 w-auto object-contain hover:scale-105 transition-transform duration-300 drop-shadow-2xl"
              loading="eager"
              decoding="async"
