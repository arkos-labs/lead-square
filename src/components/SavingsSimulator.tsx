            ...
            <div className="space-y-8">
              ...
              <div>
                <div className="flex justify-between items-center mb-3">
                  <label id="surface-label" className="text-sm font-medium text-slate-700">Surface à équiper</label>
              ...
              <div>
                <div className="flex justify-between items-center mb-3">
                  <label id="hours-label" className="text-sm font-medium text-slate-700">Heures d'éclairage par jour</label>
              ...
              <div className="flex items-center justify-between p-4 bg-white rounded-xl border border-slate-200">
                ...
                <Switch id="sensors" aria-label="Capteurs de présence" checked={hasSensors} onCheckedChange={setHasSensors} />
              </div>
