      ...
      <div className="container px-4">
        <div className="grid md:grid-cols-6 gap-6">
          ...
          <div className="md:col-span-2">
            <div className="flex items-center gap-2 mb-4 -ml-4">
              <img src={squareLogo} alt="Square Lighting Solutions" width={160} height={80} className="h-16 w-auto object-contain" loading="lazy" />
            </div>
          ...
          <div className="md:col-span-1">
            ...
            <ul className="space-y-2 text-[13px] text-muted-foreground font-medium">
              ...
              <li><Link to="/expertise/gains-maintenance" className="hover:text-primary transition-colors">Gains de maintenance</Link></li>
              <li><Link to="/expertise/productivite-eclairage" className="hover:text-primary transition-colors">Productivité & éclairage</Link></li>
        ...
        <div className="mt-6 pt-4 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex flex-wrap items-center justify-center gap-4 opacity-80">
            <img src={logoRge} alt="RGE" width={120} height={40} className="h-7 w-auto grayscale brightness-200" loading="lazy" />
            <img src={logoCee} alt="CEE" width={120} height={40} className="h-7 w-auto grayscale brightness-200" loading="lazy" />
