...
const Expertise = () => {
    return (
        <div className="min-h-screen bg-slate-50">
            <Seo
                title="Expertise LED & réglementations | Square Lighting Solutions"
                description="Actualités, aides CEE et réglementations : analyses et conseils sur l’éclairage LED industriel et la performance énergétique."
            />
            <Header />
