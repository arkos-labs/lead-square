...
const MentionsLegales = () => {
    return (
        <div className="min-h-screen bg-background text-foreground flex flex-col">
            <Seo
                title="Mentions légales | Square Lighting Solutions"
                description="Mentions légales de Square Lighting Solutions : éditeur, hébergeur, propriété intellectuelle et RGPD."
            />
            <Header />
                    ...
                    <div className="space-y-8 text-muted-foreground leading-relaxed">
                        <section className="bg-card p-6 rounded-lg border border-border/50 shadow-sm">
                            ...
                            <ul className="list-disc pl-5 space-y-1">
                                ...
                                <li><strong>RCS :</strong> Paris 884 694 332</li>
                                <li><strong>Numéro SIREN :</strong> 884 694 332</li>
                                <li><strong>Numéro de gestion :</strong> 2020B15047</li>
                                <li><strong>TVA intracommunautaire :</strong> FR75 018 846 94332</li>
                                <li><strong>Capital social :</strong> 100 000 €</li>
                                <li><strong>Directeur de la publication :</strong> M. Benaroche David Benjamin</li>
                                <li><strong>Contact :</strong> contact@square-solutions.fr • +33 6 35 88 08 86</li>
                            </ul>
                        </section>
