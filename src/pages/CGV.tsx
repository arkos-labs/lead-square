...
const CGV = () => {
    return (
        <div className="min-h-screen bg-background text-foreground flex flex-col">
            <Seo
                title="CGV | Square Lighting Solutions"
                description="Conditions Générales de Vente de Square Lighting Solutions pour les prestations de relamping LED industriel."
            />
            <Header />
