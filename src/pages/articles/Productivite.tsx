...
const Productivite = () => {
    ...
    return (
        <div className="min-h-screen bg-white">
            <Seo
                title="Productivité & éclairage LED | Square Lighting Solutions"
                description="L’impact de la qualité lumineuse sur la productivité en entrepôt : confort visuel et performance opérationnelle." 
            />
            <Header />
            <script type="application/ld+json">
                {JSON.stringify({
                    ...
                    "itemListElement": [{
                        ...
                        "item": "https://www.square-solutions.fr/expertise/productivite-eclairage"
                    }]
                })}
            </script>
            <script type="application/ld+json">
                {JSON.stringify({
                    "@context": "https://schema.org",
                    "@type": "BlogPosting",
                    "headline": "Productivité et éclairage : le confort visuel en entrepôt",
                    ...
                    "mainEntityOfPage": {
                        "@type": "WebPage",
                        "@id": "https://www.square-solutions.fr/expertise/productivite-eclairage"
                    }
                })}
            </script>
