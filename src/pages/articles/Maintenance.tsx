...
const Maintenance = () => {
    ...
    return (
        <div className="min-h-screen bg-white">
            <Seo
                title="Gains de maintenance LED | Square Lighting Solutions"
                description="Réduisez vos coûts de maintenance avec l’éclairage LED industriel : durabilité, performance et économies." 
            />
            <Header />
            <script type="application/ld+json">
                {JSON.stringify({
                    ...
                    "itemListElement": [{
                        ...
                        "item": "https://www.square-solutions.fr/expertise/gains-maintenance"
                    }]
                })}
            </script>
            <script type="application/ld+json">
                {JSON.stringify({
                    "@context": "https://schema.org",
                    "@type": "BlogPosting",
                    "headline": "Gains de maintenance : l'impact caché de la LED ou comment réduire vos coûts de 80%",
                    ...
                    "mainEntityOfPage": {
                        "@type": "WebPage",
                        "@id": "https://www.square-solutions.fr/expertise/gains-maintenance"
                    }
                })}
            </script>
