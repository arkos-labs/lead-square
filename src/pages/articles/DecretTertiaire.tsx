...
const DecretTertiaire = () => {
    ...
    return (
        <div className="min-h-screen bg-white">
            <Seo
                title="Décret Tertiaire 2024 | Square Lighting Solutions"
                description="Comprendre le Décret Tertiaire 2024-2026 et les solutions LED pour réduire rapidement la consommation énergétique des sites industriels."
            />
            <Header />
            <script type="application/ld+json">
                {JSON.stringify({
                    ...
                    "itemListElement": [{
                        ...
                        "item": "https://www.square-solutions.fr/expertise/decret-tertiaire"
                    }]
                })}
            </script>
            <script type="application/ld+json">
                {JSON.stringify({
                    "@context": "https://schema.org",
                    "@type": "BlogPosting",
                    "headline": "Le Décret Tertiaire 2024-2026 : Tout ce qu'il faut savoir pour l'industrie",
                    ...
                    "mainEntityOfPage": {
                        "@type": "WebPage",
                        "@id": "https://www.square-solutions.fr/expertise/decret-tertiaire"
                    }
                })}
            </script>
